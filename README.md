...
1. Copy the 'user_minimalcas' folder into the ownCloud's apps folder and make sure to set correct permissions for Apache.
...
If CAS provides extra attributes, user_minimalcas can retrieve the values of them. Since their name differs in various setups it is necessary to map owncloud-attribute-names to CAS-attribute-names.
